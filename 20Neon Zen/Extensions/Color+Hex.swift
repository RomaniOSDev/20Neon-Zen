...
extension Color {
    static let neonPink = Color(hex: "F00144")
    static let neonPurple = Color(hex: "FF21FF")
    static let neonGreen = Color(hex: "00FF9D")
    static let darkBackground = Color(hex: "1B1B1B")
    static let darkerBackground = Color(hex: "0A0A0A")
